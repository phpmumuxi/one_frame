var LR_isMobile = 0;
var LR_siteid = '87214784';
var LiveReceptionCode_isonline = 1;
var LR_imgurl = 'http://dbt.zoosnet.net/';
var LR_ssl = 0;
var LR_lng = 'cn';
var LR_Tick=new Date().getTime().toString()+parseInt(Math.random()*499999999+Math.random()*400000000+100000000).toString();
var LR_7ac8a='FF4C68BFC44742D28C88399FEEC36914';if(typeof(LR_showfloat)=='undefined' || LR_showfloat!=1)var LR_showfloat = 1;
LR_7ac8a=LR_7ac8a.replace(/A/g,'B').replace(/C/g,'D').replace(/E/g,'F').replace(/G/g,'H').replace(/I/g,'J').replace(/K/g,'L');var LR_websiteid = 'DBT87214784';
var LR_lxurl = 'http://dbt.zoosnet.net/';
var LR_sysurl = 'http://dbt.zoosnet.net/';
LR_7ac8a=((3+2).toString()+LR_7ac8a+(3*2).toString());var LR_ELKB=LR_7ac8a.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fdbt.zoosnet.net%2fsite%2f87214784%2fonline_cn.gif");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fdbt.zoosnet.net%2fsite%2f87214784%2foffline_cn.gif");
	var _lr_closesrc0='12.gif';
	...
	var _lr_top=((typeof(LiveReceptionCode_helpimgtop)!='undefined')?LiveReceptionCode_helpimgtop:165);
	var _lr_issupport_track= 1;
	LR_hasInstall=0;
	var LR_ivite_img='http://dbt.zoosnet.net/js/bs_blue/p.gif';
	...
	var _lr_invitestring=unescape("%3cP style%3d%22FONT-SIZE%3a 9pt%22%3e%3cBR%3e%3cBR%3e%26nbsp%3b%3c%2fP%3e%0d%0a%3cP%3e1. %u7701%u7ea7 %u56fd%u5bb6%u7ea7 %u6838%u5fc3%u671f%u520a%u5feb%u901f%u53d1%u8868%3cBR%3e2. %u804c%u79f0%u8bba%u6587%u53d1%u8868%3cBR%3e3. %u6bd5%u4e1a%u8bba%u6587%u53d1%u8868%3cBR%3e%3cFONT color%3dred size%3d2%3e%3cSTRONG%3e%u70b9%u51fb%u201c%u63a5%u53d7%u201d%3cBR%3e%u8bba%u6587%u53d1%u8868%u8f7b%u677e%u641e%u5b9a%3c%2fSTRONG%3e%3c%2fFONT%3e%3c%2fP%3e");
	...
	var LR_invitestring1_auto=unescape("%3cP%3e1. %u7701%u7ea7 %u56fd%u5bb6%u7ea7 %u6838%u5fc3%u671f%u520a%u6295%u7a3f%3cBR%3e2. %u804c%u79f0%u8bba%u6587%u53d1%u8868%3cBR%3e3. %u6bd5%u4e1a%u8bba%u6587%u53d1%u8868%3cBR%3e4.%u5404%u7c7b%u671f%u520a%u5feb%u901f%u53d1%u8868%3cBR%3e%3cFONT color%3dred size%3d2%3e%3cSTRONG%3e%u70b9%u51fb%u201c%u63a5%u53d7%u201d%3cBR%3e%u8bba%u6587%u53d1%u8868%u8f7b%u677e%u641e%u5b9a%3c%2fSTRONG%3e%3c%2fFONT%3e%3c%2fP%3e");
...
var data='id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&HJDH='+LR_ELKB;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="http://dbt.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
